export const en = {
  ...
  screens: {
    onboarding: {
      ...
      sign_up_success: {
        parent: {
          title: '|parent| You are so very welcome here',
          description:
        ...
        child: {
          ...
          description: 'That’s you all set up and ready to go!',
        },
      },
      sign_up_age: {
      ...
      sidekick_intro: {
        first: 'Who is this, who has found their way into my forest?',
        second:
        ...
        fifth: 'I forgot... how rude. Just a moment...',
        sixth:
        ...
        eighth: 'If there is anything that I or my faithful assistant...',
        ninth:
    ...
    menu: {
      main_menu: {
        header: 'Menu',
        title: 'Hi Parent!',
        description: 'You are currently playing with Child.',
      ...
      feedback: {
        ...
        success: {
          title: 'Thank you!',
          description: 'We really appreciate your feedback.',
        },
      },
      audio_settings: {
      ...
      language_settings: {
        ...
        description: 'Edit your language settings here:',
      },
      ...
      about_charm_menu: {
        title: 'About',
        description: 'Find out more about each charm below',
      },
      further_support: {
